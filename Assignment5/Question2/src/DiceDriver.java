 ...
 * 
 * Use this completed class to design and omplement a class called DiceSet that simulates a set of multiple dice. The 
 * design should store i to N objects of the Die calss using a one-dimensional array. The constructor should dynamically 
